...
INSERT INTO oas.account_owner( id, bill_type, firstname, lastname, organization, telephone, learned_about, ip_on_join, join_date, language_id ) VALUES (
...
UPDATE work.configuration_item 
	SET item_value = 'D:'||E'\\'||'workspace'||E'\\'||'PublicSiteContent'
	WHERE
...
-- hostname = localhost	
UPDATE work.configuration_item 
	SET item_value = 'localhost'
	WHERE
		application_id = (SELECT id FROM work.application WHERE identifier='OAS')
		AND identifier = 'publicHostname'
	;	
