...
public class SupportedLanguage extends BaseObject implements Comparable<SupportedLanguage> {
	...
	@Column(name = "iso3lang", insertable = true, updatable = false, unique = true, nullable = false)
	...
	/**
	 * Constructor used during application auto-registration.
	 * 
	 * @param id
	 *            Language IDs are magic numbers, required during registration
	 * @param iso3Lang
	 *            ISO 3-character code
	 */
	public SupportedLanguage(Long id, String iso3Lang) {
		//
		super(id);
		//
