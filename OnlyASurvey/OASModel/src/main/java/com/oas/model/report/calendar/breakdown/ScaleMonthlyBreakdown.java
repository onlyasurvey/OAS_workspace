 ...
 */
@Entity
@Table(schema = "oas", name = "vw_scale_monthly_breakdown")
public class ScaleMonthlyBreakdown implements ScaleCalendarBreakdown {
	...
	// ======================================================================
	public ScaleMonthlyBreakdown() {
	}

	// public ScaleMonthlyBreakdown(Survey survey, Question question, Date date,
	// Long answerValue, Long count) {
	// // set ID
	// id = new ScaleCalendarBreakdownId(question, date);
	// this.survey = survey;
