 ...
 */
@Entity
@Table(schema = "oas", name = "vw_choice_daily_breakdown")
public class ChoiceDailyBreakdown implements ChoiceCalendarBreakdown {
	...
	// ======================================================================
	public ChoiceDailyBreakdown() {

	}

	public ChoiceDailyBreakdown(Survey survey, Question question, Choice choice, Date date, Long count) {
		// set ID
		id = new ChoiceCalendarBreakdownId(choice, date);
		this.survey = survey;
