...
public class RadioCreateQuestionControllerTest extends AbstractCreateQuestionControllerTest {

	@Override
	public ModelAndView invokeCreateFormMethod(MockHttpServletRequest request) {
		return getCreateQuestionController().doRadioButtons(request);
	}

	@Override
	public ModelAndView invokeCreateSubmitMethod(MockHttpServletRequest request) throws Exception {
		return getCreateQuestionController().doRadioButtonsSubmit(request);
	}
