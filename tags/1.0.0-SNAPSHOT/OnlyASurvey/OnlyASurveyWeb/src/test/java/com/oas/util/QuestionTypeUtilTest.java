...
public class QuestionTypeUtilTest extends TestCase {
	...
	public void testGetAnswerProcessor_Fail_Boolean() {
		assertEquals("expected correct class", BooleanAnswerProcessor.class, QuestionTypeUtil.getAnswerProcessor(new BooleanQuestion()).getClass());
	}

	@Test
	public void testGetAnswerProcessor_Fail_Choice() {

		assertEquals("expected correct class", ChoiceAnswerProcessor.class, QuestionTypeUtil.getAnswerProcessor(new ChoiceQuestion()).getClass());
	}

	@Test
	public void testGetAnswerProcessor_Fail_Text() {

		assertEquals("expected correct class", TextAnswerProcessor.class, QuestionTypeUtil.getAnswerProcessor(new TextQuestion()).getClass());
	}
