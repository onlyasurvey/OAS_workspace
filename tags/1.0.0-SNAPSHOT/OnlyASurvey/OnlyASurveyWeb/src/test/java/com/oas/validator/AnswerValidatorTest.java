...
public class AnswerValidatorTest extends AbstractOASBaseTest {
	...
	@Test
	public void testTextAnswer_Success() {
	...
	@Test
	public void testTextAnswer_Fail_HugeInput() {
	...
	@Test
	public void testTextAnswer_FailRequired() {
		SimpleAnswerCommand target = new SimpleAnswerCommand();
		target.setAnswer("");
	...
	@Test
	public void testTextAnswer_AllowEmptyIfNotRequired() {
		SimpleAnswerCommand target = new SimpleAnswerCommand();
		target.setAnswer("");
	...
	@Test
	public void testTextAnswre_AllNullAnswers_FailsValidation() {
		SimpleAnswerCommand target = new SimpleAnswerCommand();
	...
	@Test
	public void testScaleAnswer_Success() {
		SimpleAnswerCommand target = new SimpleAnswerCommand();
		target.setAnswer("7");
	...
	@Test
	public void testScaleAnswer_Fail_Underflow() {
		SimpleAnswerCommand target = new SimpleAnswerCommand();
		target.setAnswer("-29");
	...
	@Test
	public void testScaleAnswer_Fail_Overflow() {
		SimpleAnswerCommand target = new SimpleAnswerCommand();
	...
	@Test
	public void testScaleAnswer_Fail_NotANumber() {
		SimpleAnswerCommand target = new SimpleAnswerCommand();
	...
	@Test
	public void testScaleAnswer_Fail_Empty() {
		SimpleAnswerCommand target = new SimpleAnswerCommand();
		target.setAnswer("");
	...
	@Test
	public void testScaleAnswer_Success_EmptyButNotRequired() {
		SimpleAnswerCommand target = new SimpleAnswerCommand();
		target.setAnswer("");
	...
	@Test
	public void testChoiceList_PassWithSelection() {
	 ...
	 */
	@Test
	public void testChoiceList_Fail_NoneOfTheAbove_OnRequired() {
	...
	@Test
	public void testChoiceList_FailWithMultiSelectionForSingleSelectQuestion() {
	...
	@Test
	public void testChoiceList_FailRequired() {
	...
	@Test
	public void testChoiceList_FailSingleSelectWithChoiceAndText() {
	 ...
	 */
	@Test
	public void testChoiceList_Success_OtherText() {
	 ...
	 */
	@Test
	public void testChoiceList_Fail_OtherSelectedButEmptyText() {
	...
	@Test
	public void testChoiceList_AllowEmptyIfNotRequired() {
	...
	@Test
	public void testFailsWithoutQuestionParameter() {
	...
	@Test
	public void testSummingQuestion() {
	...
	@Test
	public void testFail_UnknownQuestionType() {
	...
	// ======================================================================
	// @Test
	// public void testChoiceRequiredOtherTextAllowed_NoneSpecified() {
	// SimpleAnswerCommand target = new SimpleAnswerCommand();
	// Errors errors = new BindException(target, "cmd");
	//
	...
	//
	// @Test
	// public void testChoiceRequiredOtherTextAllowed_OtherTextSpecified() {
	// SimpleAnswerCommand target = new SimpleAnswerCommand();
	// Errors errors = new BindException(target, "cmd");
	//
	// // no choices selected, no other text specified
