...
<p><a href="<oas:url value='/html/db/mgt/ql/${question.survey.id}.html'/>"><fmt:message key='backTo'/> <c:out value="${question.survey.displayTitle}"/></a></p>
<h1><c:out value="${question.displayTitle}"/></h1>
<h2><spring:message code='options' text="Options"/></h2>
<div class="yui-g">

<form action="<oas:url value='/html/db/mgt/qchs/${question.id}.html'/>?" method="get">
<div>
...
<table width='100%' class="listOfQuestions"  border="0">
	...
	<c:set var="optionNumber">${loopStatus.index + 1}</c:set>
		<tr>
			<td align='left'>
				<a href="<oas:url value='/html/db/mgt/qchs/${choice.id}.html'/>?_e"><img src="<oas:url value='/incl/images/icon-edit.gif'/>"
				...
				<br/>
				<a href="<oas:url value='/html/db/mgt/qchs/${choice.id}.html'/>?_cln"><img src="<oas:url value='/incl/images/clone_icon.gif'/>"
			...
			<td>
				<a href="<oas:url value='/html/db/mgt/qchs/${choice.id}.html'/>?_mu"><img src="<oas:url value='/incl/images/arrow_up.png'/>"
				...
				<br/>
				<a href="<oas:url value='/html/db/mgt/qchs/${choice.id}.html'/>?_md"><img src="<oas:url value='/incl/images/arrow_down.png'/>"
			...
			<td align='right'>
				<a href="<oas:url value='/html/db/mgt/qchs/${choice.id}.html'/>?_d"><img src="<oas:url value='/incl/images/icon-delete.gif'/>"
...
<form action="<oas:url value='/html/db/mgt/ql/${question.survey.id}.html'/>">
