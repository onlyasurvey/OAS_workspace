...
<div class="yui-g">
	...
	<div class="tabLinkBar"> 
		...
		<a href="<oas:url value='/html/db/mgt/ql/${survey.id}.html'/>" class="button tabButton"><fmt:message key='questions'/></a>
		<a href="<oas:url value='/html/db/mgt/lnf/${survey.id}.html'/>" class="button activeTabButton"><fmt:message key='lookAndFeel'/></a>
		<a href="<oas:url value='/html/db/mgt/pref/${survey.id}.html'/>" class="button tabButton"><fmt:message key='preferences'/></a>
...
<%-- PREVIEW --%>
		<c:forEach items="${survey.supportedLanguages}" var="language">
			...
			<div class="grid_row"> 
				...
				<div class="cell_2"><a href="<oas:url value='/html/db/mgt/lnf/pvw/${survey.id}.html?l=${languageCode}'/>"
