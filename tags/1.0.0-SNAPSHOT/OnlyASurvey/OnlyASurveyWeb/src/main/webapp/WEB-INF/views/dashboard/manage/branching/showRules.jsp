...
<p><a href="<oas:url value='/html/db/mgt/ql/${survey.id}.html'/>"><fmt:message key='backTo'/> <c:out value="${question.survey.displayTitle}"/></a></p>
...
<div>
	<a href='<oas:url value='/html/db/mgt/qbr/aenr/${question.id}.html'/>'><spring:message code='branching.addEntryRule'/></a>
</div>
...
<tr>
	...
	<a href="<oas:url value='/html/db/mgt/qbr/${rule.otherObject.id}.html'/>"><c:out value='${rule.otherObject.displayTitle}'/></a>
	</c:when>
	<c:when test="${rule.otherObject.choiceType}">
	<a href="<oas:url value='/html/db/mgt/qbr/${rule.otherObject.question.id}.html'/>"><c:out value='${rule.otherObject.question.displayTitle}'/></a>
	<br/>
	&rarr;
	...
	<td>${rule.action}</td>
	<td><a href='<oas:url value="/html/db/mgt/qbr/rm/${question.id}.html?_en=${rule.id}"/>'
		><img class="deleteIcon" src="<oas:url value='/incl/images/icon-delete.gif'/>"
...
<div>
	<a href="<oas:url value='/html/db/mgt/qbr/aexr/${question.id}.html'/>"><spring:message code='branching.addExitRule'/></a>
</div>
...
<tr>
	...
	<a href="<oas:url value='/html/db/mgt/qbr/${rule.jumpToQuestion.id}.html'/>"><c:out value='${rule.jumpToQuestion.displayTitle}'/></a>
	</c:when>
	<c:otherwise>&nbsp;</c:otherwise>
	</c:choose>
	</td>
	<td><a href='<oas:url value="/html/db/mgt/qbr/rm/${question.id}.html?_ex=${rule.id}"/>'
		><img class="deleteIcon" src="<oas:url value='/incl/images/icon-delete.gif'/>"
			alt="<spring:message code='branching.deleteEntryRule' arguments="${i.index + 1}"/>"
			title="<spring:message code='branching.deleteEntryRule' arguments="${i.index + 1}"/>" /></a>
	</td>
...
<li><a href="<oas:url value='/html/db/mgt/qbr/${reference.id}.html'/>"><c:out value="${reference.displayTitle}"/></a></li>
</c:forEach>
</ul>
</c:if>
