<%@page import="com.oas.util.QuestionTypeCode;"%><%@ include
	file="/WEB-INF/views/includes.jspf"%>
<title><fmt:message key="createQuestion.pageTitle" />
</title>
<c:set var="defaultQuestionTitle">
	<fmt:message key='createQuestion.defaultNewName' />
</c:set>
<h1>
	<fmt:message key="createQuestion.pageTitle" />
</h1>
<p>
	<fmt:message key="createQuestion.introText" />
</p>
...
<div class="yui-g">
	<h2>
		<fmt:message key="createQuestion.type.openTextFields" />
	</h2>
</div>
<div class="yui-g seperator">
	...
	<div class="yui-u">
		<img src="<oas:url value='/incl/images/example_questions/text_field.png'/>"
...
<div class="yui-g ">
	...
	<div class="yui-u">
		<img src="<oas:url value='/incl/images/example_questions/text_area_essay_question.png'/>"
...
<div class="yui-g seperator">
	...
	<div class="yui-u">
		<img src="<oas:url value='/incl/images/example_questions/radio_buttons.png'/>"
...
<div class="yui-g seperator">
	...
	<div class="yui-u">
		<img src="<oas:url value='/incl/images/example_questions/check_boxes.png'/>"
...
<div class="yui-g seperator">
	...
	<div class="yui-u">
		<img src="<oas:url value='/incl/images/example_questions/select_list.png'/>"
...
<div class="yui-g seperator">
	...
	<div class="yui-u">
		<img src="<oas:url value='/incl/images/example_questions/rating_scale.png'/>"
...
<div class="yui-g seperator">
	...
	<div class="yui-u">
		<img src="<oas:url value='/incl/images/example_questions/constant_sum.png'/>"
...
<form action="<oas:url value='/html/db/mgt/ql/${survey.id}.html'/>" method='get'>
<div class="buttonBar">
