...
<div class="yui-g"> 
<p><a href="<oas:url value='/html/db/mgt/pb/${survey.id}.html'/>"><fmt:message key='invitesPage.backLink'/></a></p>
...
<c:if test="${not empty inviteList }">
	...
	<a href="dl/${lid.id}.html">
	<img src="<oas:url value='/incl/images/icon-delete.gif'/>" alt="<c:out value='${deleteTitle}'/>"
...
<form action="<oas:url value='/html/db/mgt/pb/${survey.id}.html'/>" method="get">
