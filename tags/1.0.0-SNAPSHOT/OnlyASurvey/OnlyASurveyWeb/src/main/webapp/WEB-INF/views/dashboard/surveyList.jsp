...
<form class="newSurveyForm" action="<oas:url value='/html/db/crt.html'/>" method="get">
<div>
		...
		<tr>
			...
			<td>
				<c:if test="${summary.survey.changeAllowed}">
					...
					<img class="icon" src="<oas:url value='/incl/images/view.gif'/>"
						alt="<fmt:message key='viewSurveyIconAlt'/> ${surveyName}" title="<fmt:message key='viewSurveyIconAlt'/> ${surveyName}"	/>
					<a href='<oas:url value="/html/db/mgt/rm/${summary.survey.id}.html"/>'><img class="deleteIcon" src="<oas:url value='/incl/images/icon-delete.gif'/>"
				...
				<c:if test="${!summary.survey.changeAllowed}">
					<img class="icon" src="<oas:url value='/incl/images/edit_disabled.png'/>"
					...
					<img class="deleteIcon" src="<oas:url value='/incl/images/icon-delete_disabled.gif'/>"
