...
public class BranchingController extends AbstractOASController {
	...
	private BranchingRule getRule(Long entryRuleId, Long exitRuleId) {
	...
	@ValidUser
	public ModelAndView addEntryRuleSubmit(HttpServletRequest request, int wn, int wt, long wnOp, long wnChOp) {
