...
public class ManageSurveyController extends AbstractOASController {
	...
	public ModelAndView doMain(HttpServletRequest request, HttpServletResponse response) {
		...
		ObjectTextCommand welcomeMessage = domainModelService.findObjectText(survey, "welcomeMessage");
		ObjectTextCommand thanksMessage = domainModelService.findObjectText(survey, "thanksMessage");
